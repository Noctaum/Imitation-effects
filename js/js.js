...
//Строим график P=f(I)
	$('#bigTable').append('<div class="nameOfShedule"><h3>График зависимости P=f(I<sub>K</sub>)</h3></div>');
	$('#bigTable').append('<canvas height="500px" width="500px" id="schedule">schedule</canvas>');
...
//Строим график P=f(T)
    $('#bigTable').append('<div class="nameOfShedule"><h3>График зависимости P=f(t)</h3></div>');
	$('#bigTable').append('<canvas height="500px" width="500px" id="schedule1">schedule</canvas>');
...
//Создаем ссылку на скачивание
	$('#bigTable').append('<div><h5><a id="download1"> Скачать</a></h5></div>');
...
//Выводим среднюю ошибку прогнозирования
	$('#bigTable4').append('<hr>');	
	$('#bigTable4').append('<div><h3>Cредняя ошибка прогнозирования = '+mistake+'</h3></div>');
	$('#bigTable4').append('<div><label><input id="first" class="number2 inputBeforeSchedule2" placeholder="Время наработки"></label><p id="second"></p></div>');
}
